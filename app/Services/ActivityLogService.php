...
class ActivityLogService
{
    ...
    protected static array $routeLabels = [
        ...
        'admin.processes.store' => 'Creó solicitud',
        'admin.processes.destroy' => 'Eliminó solicitud',
        'admin.processes.link-to-quote' => 'Vinculó solicitud a cotización',
        'admin.processes.submissions.store' => 'Registró sometimiento',
        'admin.processes.checklist-items.store' => 'Agregó ítem a checklist',
        'admin.processes.documents.upload' => 'Subió documento a solicitud (Drive)',
        'admin.processes.documents.destroy' => 'Eliminó documento de solicitud',
