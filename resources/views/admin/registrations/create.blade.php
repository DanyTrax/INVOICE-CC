                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <div class="relative" x-data="{ 
                            ...
                            loading: false,
                            init() {
                                this.search = '{{ old('company_search', '') }}';
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" 
                               ...
                               placeholder="Ej: Registro Sanitario, Renovación..."
                    ...
                    <div>
                        ...
                        <select id="status" 
                                ...
                                required
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-teal-500 focus:border-teal-500 block w-full p-2.5">
                            <option value="tramite" {{ old('status', 'tramite') === 'tramite' ? 'selected' : '' }}>En Trámite</option>
                            <option value="vigente" {{ old('status') === 'vigente' ? 'selected' : '' }}>Vigente</option>
                            <option value="requerimiento" {{ old('status') === 'requerimiento' ? 'selected' : '' }}>Requerimiento</option>
                    ...
                    <div>
                        ...
                        <select id="assigned_specialist_id" 
                            ...
                            @foreach($specialists as $specialist)
                                <option value="{{ $specialist->id }}" {{ old('assigned_specialist_id') == $specialist->id ? 'selected' : '' }}>
                                    {{ $specialist->name }}
                                </option>
                            @endforeach
                        </select>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="date" 
                               ...
                               value="{{ old('response_radication_date') }}"
                               class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-teal-500 focus:border-teal-500 block w-full p-2.5">
                    </div>
                ...
                <div class="grid grid-cols-1 gap-6">
                    <div>
                        ...
                        <textarea id="client_requirement" 
                                  ...
                                  rows="3"
                                  class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-teal-500 focus:border-teal-500 block w-full p-2.5">{{ old('client_requirement') }}</textarea>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea id="invima_requirement" 
                                  ...
                                  rows="3"
                                  class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-teal-500 focus:border-teal-500 block w-full p-2.5">{{ old('invima_requirement') }}</textarea>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea id="pending_docs" 
                                  name="pending_docs" 
                                  rows="3"
                                  class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-teal-500 focus:border-teal-500 block w-full p-2.5">{{ old('pending_docs') }}</textarea>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea id="observations" 
                                  name="observations" 
                                  rows="4"
                                  class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-teal-500 focus:border-teal-500 block w-full p-2.5">{{ old('observations') }}</textarea>
                    </div>
                </div>
            </div>
