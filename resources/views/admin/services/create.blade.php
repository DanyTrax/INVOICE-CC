...
@section('title', 'Nuevo Servicio - RAMS')
            ...
            <div class="grid grid-cols-1 gap-6">
                ...
                <div>
                    ...
                    <textarea id="default_scope" name="default_scope" rows="5"
                              class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-teal-500 focus:border-teal-500 block w-full p-2.5 @error('default_scope') border-red-500 @enderror">{{ old('default_scope') }}</textarea>
