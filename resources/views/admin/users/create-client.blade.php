            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <div class="flex items-center h-10">
                        ...
                        <label for="is_active" class="ml-2 text-sm text-gray-900">Cliente activo</label>
                    </div>
                </div>
                ...
                <div class="md:col-span-2">
                    ...
                    <p class="mt-2 text-xs text-gray-500">Selecciona las empresas que estarán asignadas a este cliente</p>
                    @error('companies')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
