...
<div class="grid grid-cols-1 md:grid-cols-2 gap-6">
    ...
    <div class="md:col-span-2">
        ...
        <p class="mt-1 text-xs text-gray-500">
            Variables: <code class="bg-gray-100 px-1 rounded">@verbatim {{fecha}} @endverbatim</code>,
            ...
            <code class="bg-gray-100 px-1 rounded">@verbatim {{consecutivo}} @endverbatim</code> (número de propuesta),
    ...
    <div class="md:col-span-2">
        <label class="inline-flex items-center gap-2">
            ...
            <span class="text-sm font-medium text-gray-900">Usar como plantilla por defecto al generar PDF de propuestas</span>
        </label>
    </div>
</div>
